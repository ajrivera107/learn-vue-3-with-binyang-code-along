<template>
  ...
  <h2>Number of active users (computed): {{ numberOfActiveUsers }}</h2>
  <h2>Number of active users (computed): {{ numberOfActiveUsers }}</h2>
  <h2>Number of active users (computed): {{ numberOfActiveUsers }}</h2>

  <h2>Number of active users (method call): {{ computedNumberOfActiveUsers() }}</h2>
  <h2>Number of active users (method call): {{ computedNumberOfActiveUsers() }}</h2>
  <h2>Number of active users (method call): {{ computedNumberOfActiveUsers() }}</h2>
...
let toggleButtonName = computed(() =>
 hideInactive ? 'Show all': 'Hide active'
)
...
let computedNumberOfActiveUsers = () => {
